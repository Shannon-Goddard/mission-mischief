...
| Mugshot downloaded image does not have black/white overlay. Would it be easier to have image goto devices photo library? | [ ] | [x] |
...
| The content on the page is too wide (regression from previous fix/change). Also, instead scrolling, the entire screen moves. | [ ] | [x] |
